package xiaoma.jupiter.recommendation;
...
public class ItemRecommender {
    ...
    // return a list of Item objects for the given type. Types are one of [Stream, Video, Clip].
    // All items are related to the items previously favorited by the user. E.g., if a user favorited some videos about
    // game "Just Chatting", then it will return some other videos about the same game
    private List<Item> recommendByFavoriteHistory(Set<String> favoritedItemIds, List<String> favoriteGameIds, ItemType type)
        ...
        // sort the game Id by the count. E.g. if the input is {"1234": 1, "2345": 2, "3456": 1},
    ...
    // Keys of items are [Stream, Video, Clip]
    // Each key is corresponding to a list of Item objects, each item object is a recommended item based on the
    ...
    // Return a map of Item objects as the recommendation result
    // Keys of items are [Stream, Video, Clip]
    // Each key is corresponding to a list of Item objects, each item object is a recommended item
